      ...
      <div className="screen-max-width">
        <div>
          <p className="text-xs font-semibold text-gray">
            ...
            or
            <span className="text-blue underline"> other reatailer </span>
            near you.
          </p>
          <p className="text-xs font-semibold text-gray">Or call 093-51-81-100</p>
        </div>
        <div className="my-5 h-[1px] w-full bg-neutral-700" />
        <div className="flex flex-col justify-between md:flex-row md:items-center">
          <p className="text-xs font-semibold text-gray">Copyright &copy;2024 Apple Inc. All rights reserved.</p>
          <div className="flex">
